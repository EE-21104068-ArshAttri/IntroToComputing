...
#Now, For a single letter

if len(input_string)==1:
    input_string = input_string[0]
#Making an empty list to enter the occurences a word/letter
...
#Question 2
print("Question: 2")
#Defining a function of a leap year
...
#Now making a list for integers
